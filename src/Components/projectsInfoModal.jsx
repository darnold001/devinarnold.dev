...
export default function ProjectsInfoModal(props) {
  return (
    <div
      className="projects-modal-wrapper"
    >
      <div className="projects-info-modal">
        <img className = 'closeIcon' src ={closeIcon} alt='close icon' onClick = {() => props.setModal(undefined)}/>
        <div>
          {props.modal.photos.length > 1 && <Carousel photos={props.modal.photos}/>}
